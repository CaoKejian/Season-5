  ...
  <div class="wrapper">
    ...
    <div class="curlture">
        ...
        <div class="issue" v-show="isShowIssue">
            ...
            <h4>如何申请退换货？</h4>
                <p>所有产品均为高档礼品，无质量问题不支持退换货；</p>
                <p>如因喜好不同，或到货后后悔等原因，不支持退货；</p>
                <p>因客户原因如联系方式有误、电话停机、不接电话、无理由拒收等造成快件无法正常签收的情况，第五季节均不进行补发或赔付；</p>
                <p>如因质量问题需要退货，将由客服人员与客户联系，确认邮寄地址与流程。退回物品不得有人为损坏或使用痕迹，否则拒绝退换；</p>
                <p class="mb20">如顾客选择自行寄回商品，请先垫付运费，到货验证商品后，第五季节将以支出来源发放形式为用户报销运费，不接受单方面到付件。</p>
                <h4>如何开具发票？</h4>
                <p>第五季节产品均为定制礼品，凡购买的礼品支持开票。</p>
                <h4>关于商品价格问题</h4>
                <p class="mb20">因可能存在系统缓存、页面更新延迟等不确定性情况，导致价格显示异常，商品具体售价请以订单结算页价格为准。如您发现异常情况出现，请立即联系我们补正，以便您能顺兑换。</p>
                <h4>联系我们 <a href="https://caokejian.github.io/Season-5/dist">https://caokejian.github.io/Season-5/dist</a> </h4>
                <p></p>
        </div>
    </div>
  </div>
